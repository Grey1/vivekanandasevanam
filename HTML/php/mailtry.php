...
$mail->SMTPDebug  = 2;
$mail->From = "arjun@gmail.com";
$mail->FromName = "Asad";
$mail->Host = "smtp.gmail.com"; // specif smtp server
$mail->SMTPSecure= "ssl"; // Used instead of TLS when only POP mail is selected
$mail->Port = 465; // Used instead of 587 when only POP mail is selected
$mail->SMTPAuth = true;
$mail->Username = "arjun@gmail.com"; // SMTP username
$mail->Password = "arjun"; // SMTP password
$mail->AddAddress($ml, "UniverCell"); //replace myname and mypassword to yours
$mail->AddReplyTo("univercellshop2@gmail.com", "UniverCell");
$mail->addBCC('univercellshop2@gmail.com');
